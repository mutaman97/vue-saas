...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Create Brand'),'prev'=> url('seller/brand')])
@endsection
                     ...
                     <div class="card">
                        <div class="card-body">
                           <div class="from-group row mb-2">
                                 ...
                                 <div class="col-lg-12">
                                       <input type="text" name="name" class="form-control" placeholder="{{ __('Enter Brand Name') }}">
                                 </div>
                              </div>
                              <div class="from-group row mb-2">
