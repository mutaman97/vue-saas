...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Products'),'button_name'=> __('Create New'),'button_link'=> url('seller/product/create')])
@endsection
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('Name') }}</th>
                            <th class="text-right">{{ __('Image') }}</th>
                        ...
                        <tr id="row{{  $row->id }}">
                            <td>
                                <div class="custom-control custom-checkbox">
                                  ...
                                  <td class="text-right">
                                    <a class="btn btn-sm btn-outline-primary" href="{{ route('seller.product.edit', $row->id) }}" data-toggle="tooltip" title="{{ __('Edit') }}"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
