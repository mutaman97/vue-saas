...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Edit Product Price'),'prev'=> url('seller/product')])
@endsection
                    ...
                    @foreach($row->priceswithcategories ?? [] as $priceswithcategory)
                     <div class=" " id="childcard{{$priceswithcategory->category_id}}">
                        ...
                        <div class=" row">
                           ...
                           <div class="from-group col-lg-6  mb-2">
                              <label for="" >{{ __('Stock manage') }} </label>
                              <div >
...
<script src="{{ asset('admin/js/product-price.js') }}"></script>
