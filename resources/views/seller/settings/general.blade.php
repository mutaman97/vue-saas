   ...
   <div class="col-lg-12">
      <form class="ajaxform" method="post" action="{{ route('seller.site-settings.update','general') }}">
               ...
               <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-2">
                        <label for="" class="col-lg-12">{{ __('Store Theme Color') }}</label>
                        <div class="col-lg-12">
                            <input type="text" value={{ json_decode($theme_color->value) ?? '' }} class="form-control colorpickerinput" required  name="theme_color">
                            <small>{{ __('This will change the entire color of your store, depending on your brand identity') }}</small>
                        </div>
                    </div>
                    <div class="from-group row mb-2">
         ...
         <div class="row">
            {{-- left side --}}
            <div class="col-lg-4">
                <h6>{{ __('Store Details') }}</h6>
                <strong>{{ __('Some of these details will appear on your invoices') }}</strong>
            </div>
            {{-- /left side --}}
            {{-- right side --}}
            <div class="col-lg-8">
               <div class="card">
                  <div class="card-body">
                    <div class="from-group row mb-2">
                        <label for="" class="col-lg-12">{{ __('Store legal name') }}  </label>
                        <div class="col-lg-12">
                            <input type="text" value="{{ $invoice_data->store_legal_name ?? '' }}" name="store_legal_name" class="form-control" max="50">
                        </div>
                    </div>
                    <div class="from-group row mb-2">
                        <label for="" class="col-lg-12">{{ __('Store Description') }}  </label>
                        <div class="col-lg-12">
                            <textarea name="store_legal_description" class="form-control  h-150" rows="4" maxlength="400">{{ $invoice_data->store_legal_description ?? '' }}</textarea>
                        </div>
                    </div>
                    <div class="from-group row mb-2">
