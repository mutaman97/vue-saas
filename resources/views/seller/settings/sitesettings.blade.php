...
<div class="section-body">
  ...
  <div class="col-lg-6">
    <div class="card card-large-icons">
      ...
      <div class="card-body">
        <h4> @if(tenant('push_notification') != 'on' ) <i class="fa fa-lock text-danger"></i> @endif {{ __('Notifications') }}</h4>
  ...
  <div class="col-lg-6">
    <div class="card card-large-icons">
      ...
      <div class="card-body">
        ...
        <a href="{{ url('/seller/mediacompress') }}" class="card-cta">{{ __('Change Settings') }} <i class="fas fa-chevron-right"></i></a>
      </div>
    </div>
  </div>
