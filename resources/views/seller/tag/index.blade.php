...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Tags'),'button_name'=> __('Create'),'button_link'=> url('seller/tag/create')])
@endsection
                                ...
                                <tr>
                                  ...
                                  <td class="">
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('seller.tag.edit', $row->id) }}"><i class="fa fa-edit"></i></a>
