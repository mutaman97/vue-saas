                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="from-group row mb-2">
                           ...
                           <div class="col-lg-12">
                              <input value="{{ $info->name }}" type="text" name="name" class="form-control" placeholder="{{ __('Enter Category Name') }}">
                           </div>
                        </div>
                        <div class="from-group row mb-2">
                           <label for="" class="col-lg-12">{{ __('Slug') }}</label>
                           <div class="col-lg-12">
                              <input value="{{ $info->slug }}" type="text" name="slug" class="form-control" placeholder="{{ __('Enter Category Slug') }}">
                           </div>
                        </div>
                        <div class="from-group row mb-2">
