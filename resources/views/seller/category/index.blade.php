...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Categories'),'button_name'=> __('Create New'),'button_link'=> url('seller/category/create')])
@endsection
                                ...
                                <tr>
                                  ...
                                  <td class="">
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('seller.category.edit', $row->id) }}"><i class="fa fa-edit"></i></a>
