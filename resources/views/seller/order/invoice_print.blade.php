                                ...
                                <div class="col-lg-6">
                                    <div class="invoice-bill-form">
                                        ...
                                        <div class="store-name">
                                            ...
                                            <p>{{ __('Postal Code') }} {{ isset($order->shippingwithinfo->info) ? json_decode($order->shippingwithinfo->info)->post_code : '' }}</p>
                                        </div>
                                        <div class="store-email">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="note-section">
                                        <h4>NOTES/MEMO</h4>
                                        <p>{{ isset($order->ordermeta->value) ? json_decode($order->ordermeta->value)->note : '' }}</p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="invoice-table-area">
