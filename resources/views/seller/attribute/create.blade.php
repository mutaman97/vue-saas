           ...
           <form class="ajaxform_with_reset" method="post" action="{{ route('seller.attribute.store') }}">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="from-group row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input type="text" name="parent_name" class="form-control" required="" placeholder="{{ __('Parent Attribute') }}">
                                </div>
                            </div>
                            <div class="from-group row mb-2">
             ...
             <div class="row">
                {{-- left side --}}
                <div class="col-lg-5">
                    <strong>{{ __('Child Attributes') }}</strong>
                    <p>{{ __('Add your child attributes and necessary information from here') }}</p>
                </div>
                {{-- /left side --}}
