         ...
         <div class="row">
            ...
            <div class="col-lg-5">
               <strong>{{ __('Information') }}</strong>
                <p>{{ __('Here you can easily add your delivery rider details') }}</p>
            </div>
            {{-- /left side --}}
            {{-- right side --}}
            <div class="col-lg-7">
                    ...
                    <div class="card-body">
                        <div class="from-group row mb-2">
                            ...
                            <div class="from-group row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input type="email" required name="email" class="form-control" placeholder="{{ __('Enter Email Address') }}">
                                </div>
                            </div>
                            <div class="from-group row mb-2">
                            ...
                            <div class="from-group row mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input type="password" required name="password_confirmation" class="form-control" placeholder="{{ __('Enter Confirmation Password') }}">
                                </div>
                            </div>
                            <div class="from-group row mb-2">
