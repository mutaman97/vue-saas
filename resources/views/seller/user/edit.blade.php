                ...
                <div class="card">
                    <div class="card-body">
                        <div class="from-group row mb-2">
                            ...
                            <div class="col-lg-12">
                                <input type="text" required name="name" class="form-control" placeholder="{{ __('Enter User Name') }}" value="{{ $user->name }}">
                            </div>
                        </div>
                        <div class="from-group row mb-2">
                            <label for="" class="col-lg-12">{{ __('Email') }} </label>
                            <div class="col-lg-12">
                                <input type="email" required name="email" class="form-control" placeholder="{{ __('Enter Email Address') }}" value="{{ $user->email }}">
                            </div>
                        </div>
                        <div class="from-group row mb-2">
                        ...
                        <div class="from-group row mb-2">
                            ...
                            <div class="col-lg-12">
                                <input type="password" name="password_confirmation" class="form-control" placeholder="{{ __('Enter Confirmation Password') }}">
                            </div>
                        </div>
                        <div class="from-group row mb-2">
