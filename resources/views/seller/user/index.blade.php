...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Users'),'button_name'=> __('Create New'),'button_link'=> url('seller/user/create')])
@endsection
                        ...
                        <table class="table table-striped table-hover text-center table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  <td>{{ $row->name }}</td>
                                  <td>{{ $row->email }}</td>
                                  <td><span class="badge badge-{{ $row->status == 1 ? 'success' : 'warning' }}">{{ $row->status == 1 ? __('Active') : __('Disabled') }}</span></td>
                                  <td class="">
