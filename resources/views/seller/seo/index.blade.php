...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('SEO Settings')])
@endsection
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if($key == 0) active @endif"  data-toggle="tab" href="#{{$row}}" role="tab" aria-controls="home" aria-selected="true">{{ __(ucwords(str_replace('_',' ',$row))) }}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
