                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" required name="coupon_code" class="form-control" placeholder="{{ __('Enter Coupon Code') }}">
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        <label for="" class="col-lg-12">{{ __('Value') }}</label>
                                        <div class="col-lg-12">
                                            <input type="number" required="" value="0" step="any" name="price" class="form-control" placeholder="{{ __('Enter Percentage Rate Or Flat Rate') }}">
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        ...
                                        <div class="col-lg-12">
                                            <select class="form-control" name="discount_type" >
                                                <option value="1">{{ __('Percentage Discount') }}</option>
                                                <option value="0">{{ __('Flat Discount') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="from-group row mb-2">
                                        <label for="" class="col-lg-12">{{ __('Is Conditional Discount?') }}</label>
                                        <div class="col-lg-12">
