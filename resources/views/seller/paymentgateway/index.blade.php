                        ...
                        <div class="col-12 col-sm-12 col-md-4">
                          <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            <li class="nav-item py-2">
                              <a class="nav-link active" id="home-tab4" data-toggle="tab" href="#home4" role="tab" aria-controls="home" aria-selected="false">{{ __('Offline Payment Gateways') }}</a>
                            </li>
                            <li class="nav-item py-2">
                              <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4" role="tab" aria-controls="profile" aria-selected="false">{{ __('Online Payment Gateways') }}</a>
                            </li>
                          </ul>
                        </div>
                            ...
                            <div class="tab-pane fade active show" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                              ...
                              <div class="payment-gateway-section">
                                ...
                                <div class="single-payment-gateway mb-3">
                                    ...
                                    <div class="gateway-right">
                                      <a href="{{ route('seller.payment.uninstall',$gateway->id) }}" class="btn btn-danger">{{ __('Remove') }}</a>
                                    </div>
                                </div>
                                @endif
                                @endforeach
                            ...
                            <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                                <div class="payment-gateway-section">
                                    ...
                                    <div class="single-payment-gateway">
                                        ...
                                        <div class="gateway-right">
                                          <a href="{{ route('seller.payment.uninstall',$row->id) }}" class="btn btn-danger">{{ __('Remove') }}</a>
                                        </div>
                                        @endif
                                        @endforeach
