<li class="menu-header">{{ __('My Store') }}</li>
<li class="mute">
...
<li class="{{ Request::is('seller/product*') ? 'active' : '' }} {{ Request::is('seller/barcode*') ? 'active' : '' }}">
    ...
    <ul class="dropdown-menu" >
        ...
        <li>
            <a class="nav-link" href="{{ url('/seller/barcode') }}">{{ __('Barcode Print') }}@if(tenant('barcode') != 'on' )<i class="fa fa-lock text-danger"></i> @endif</a>
        </li>
        <li>
...
<li class="{{ Request::is('seller/settings*') ? 'active' : '' }} {{ Request::is('seller/settings*') ? 'active' : '' }}">
    ...
    <ul class="dropdown-menu" >
       ...
       <li><a class="nav-link" href="{{ url('/seller/settings/custom_css_js') }}"><span>{{ __('Additional Css & Js') }} @if(tenant('custom_css_js') != 'on' ) <i class="fa fa-lock text-danger"></i> @endif </span></a></li>
       <li><a class="nav-link" href="{{ url('/seller/settings/pwa') }}"><span>{{ __('PWA Configuration') }} @if(tenant('pwa') != 'on' ) <i class="fa fa-lock text-danger"></i> @endif</span></a></li>
