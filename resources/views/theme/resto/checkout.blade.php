								...
								<div class="content">
									<div class="checkbox">
										...
										@foreach($getways as $getway)
											<label class="checkbox-inline" for="getway{{ $getway->id }}"><input name="payment_method" class="getway" id="getway{{ $getway->id }}" type="radio" data-logo="{{ $getway->logo }}" data-rate="{{ $getway->rate }}"  data-charge="{{ $getway->charge }}" data-currency="{{ $getway->currency_name }}" data-instruction="{{ $getway->instruction }}" 
												@if($getway->is_auto == 0)
													@php
													...
													@endif
												@else
													data-name="" data-account_number="" data-branch=""

												@endif
												value="{{ $getway->id }}"> {{ $getway->name }}
											</label>
										@endforeach
									</div>
									<ul class="none payement_inst">
										...
										<li class="name_area none">
											{{ __('Name : ') }} <span class="name"></span>
										</li>
										<li class="account_number_area none">
											{{ __('Account Number : ') }} <span class="account_number"></span>
										</li>
										<li class="branch_area none">
											{{ __('Branch : ') }} <span class="branch"></span>
										</li>
...
<!-- <script type="text/javascript" src="https://s3.eu-west-1.wasabisys.com/sala/uploads/checkout.js"></script> -->
