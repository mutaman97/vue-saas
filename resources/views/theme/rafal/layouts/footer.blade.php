<footer class="page-footer footer-style-6 holder-mt-small">
			...
			<div class="row mt-0">
				<div class="col-lg col-xl last-mobile">
					<div class="footer-block">
						...
						<div class="collapsed-content pt-1">
	...
	<div class="footer-bottom footer-bottom--bg">
		<div class="container">
			...
			<div class="footer-copyright text-center pt-2">
				<p>Made with <i class="icon-heart text-danger"></i> by <a href="#" >Sala Platform</a></p>
			</div>
		</div>
	</div>
</footer>
