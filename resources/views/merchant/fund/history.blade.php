...
@section('title',__('Fund History'))

@section('head')
    @include('layouts.backend.partials.headersection',['title'=>__('Fund History')])
@endsection
                    ...
                    @foreach ($funds ?? [] as $fund)
                        <tr>
                            ...
                            <td>
                                @php
                                 $payment_status = [
                                    0 => ['class' => 'badge-danger', 'text' => __('Failed')],
                                    1 => ['class' => 'badge-primary', 'text' => __('Active')],
                            ...
                            <td>
                                <div class="fund-button">
                                    <a class="btn btn-sm btn-outline-primary" href="{{ route('merchant.fund.show', $fund->id) }}" data-toggle="tooltip" title="{{ __('View') }}"><i class="fa fa-eye"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
