...
@section('title',__('Select Payment Getway'))

@section('head')
@include('layouts.backend.partials.headersection',['title'=>  $plan->is_trial == 1 ? __('Enter Store name') : __('Select Payment Getway')])
@endsection
