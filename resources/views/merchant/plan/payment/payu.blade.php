...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{ route('merchant.payu.status') }}" method="post" name="payuForm" id="payment_form">
                @csrf
...
<script id="bolt" src="https://sandboxcheckout-static.citruspay.com/bolt/run/bolt.min.js" bolt-
