...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Transfer Store'),'prev'=>route('merchant.domain.list')])
@endsection
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('merchant.domain.transfer.otp',$info->id) }}" class="ajaxform">
                    ...
                    <div class="form-group row mb-4">
                        <label
                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('New Owner Email') }}</label>
