...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>__('Domain Settings'),'prev'=>route('merchant.domain.list')])
@endsection
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h4>
                                {{-- @if(tenant('custom_domain') != 'on' ) <i class="fa fa-lock text-danger"></i> @endif  --}}
                                {{ __('Custom domain') }}</h4>
                            <div class="card-header-action">
            ...
            <form class="ajaxform_with_reload" action="{{ route('merchant.add.subdomain',$info->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        {{-- <label>{{ __('Add Subdomain') }}</label>
                        <div class="form-group">
                            <div class="input-group mb-2">
                                <input type="text" class="form-control text-right" name="subdomain" placeholder="{{ __('Enter Shop Name') }}" value="{{ $info->id }}">
                        ...
                        <div class="">
                            <div dir="ltr" class="store-url-section">
                                <input type="text" name="subdomain" placeholder="{{ __('Enter Shop Name') }}" value="{{ $info->id }}" class="form-control">
                                <div class="store-domain-name">
                                    <span>.{{ env('APP_PROTOCOLESS_URL') }}</span>
                                </div>
                            </div>
                            <div class="form-text text-muted">{{ __('Example:') }} {example}.{{ env('APP_PROTOCOLESS_URL') }}</div>
                        </div>
                    </div>
                </div>
            ...
            <form class="ajaxform_with_reload" action="{{ route('merchant.update.subdomain',$info->id) }}">
                ...
                <div class="modal-body">
                    {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                <input type="text" class="form-control text-right" name="subdomain" placeholder="{{ __('Enter Shop Name') }}" value="{{ str_replace('.'.env('APP_PROTOCOLESS_URL'), '', $info->subdomain->domain) }}">
                                <div class="input-group-append">
                                    <div class="input-group-text">.{{ env('APP_PROTOCOLESS_URL') }}</div>
                                </div>
                            </div>
                    ...
                    <div class="">
                        <div dir="ltr" class="store-url-section">
                            <input type="text" name="subdomain" placeholder="{{ __('Enter Shop Name') }}" value="{{ str_replace('.'.env('APP_PROTOCOLESS_URL'), '', $info->subdomain->domain) }}" class="form-control">
                            <div class="store-domain-name">
                                <span>.{{ env('APP_PROTOCOLESS_URL') }}</span>
                            </div>
                        </div>
                ...
                <div class="modal-card card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">{{ __('Enter the domain you want to connect with your store') }}</small>
                    </div>
                    <div class="form-group">
