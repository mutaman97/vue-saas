                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#enlighten" role="tab" aria-controls="driver" aria-selected="false">{{ __('Laravel Enlighten') }}</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="tab-content no-padding" id="myTab2Content">
                            <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('DEBUGBAR') }}</label>
                                    <select class="form-control" name="DEBUGBAR">
                                        <option value="true" @if(env('DEBUGBAR_ENABLED') == true) selected="" @endif>true (Developers Only)</option>
                                        <option value="false" @if(env('DEBUGBAR_ENABLED') == false) selected="" @endif>false</option>
                                    </select>
                                </div>
                            ...
                            <div class="tab-pane fade" id="enlighten" role="tabpanel" aria-labelledby="profile-tab4">
                                <h6>{{ __('Laravel Enlighten') }}</h6>
                                <p>{{ __('Test Laravel App Perfomance') }}</p>

                                <div class="form-group">
                                    <label>{{ __('ENLIGHTN_USERNAME') }}</label>
                                    <input type="text"  name="ENLIGHTN_USERNAME" class="form-control" value="{{ env('ENLIGHTN_USERNAME') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('ENLIGHTN_API_TOKEN') }}</label>
                                    <input type="text"  name="ENLIGHTN_API_TOKEN" class="form-control" value="{{ env('ENLIGHTN_API_TOKEN') }}">
                                </div>
                            </div>

                            <div class="tab-pane fade" id="recaptcha" role="tabpanel" aria-labelledby="profile-tab4">
                                <h6>{{ __('Google Recaptcha') }}</h6>
                                <p>{{ __('Laravel Security') }}</p>
