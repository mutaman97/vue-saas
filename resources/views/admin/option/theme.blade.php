            ...
            <div class="col-lg-6">
                <div class="card card-large-icons">
                  ...
                  <div class="card-body">
                    ...
                    <p>{{ _('Use this feature to create, edit, update, and delete testimonials as per your business needs') }}</p>
                    <a href="{{ route('admin.settings.testimonials') }}" class="card-cta">{{ __('Change Settings') }} <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
              </div>
        </div>
