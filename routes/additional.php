...
Route::group(['domain' => env('APP_URL'),'middleware' => ['web']], function () {
    ...
    // Added By Mutaman For Syberpay
    Route::post('/syberpay/notify', '\App\Lib\Syberpay@notify');
    Route::post('/syberpay/payment-success', '\App\Lib\Syberpay@syberpaysuccess');
});
...
Route::group(['middleware' => ['web','InitializeTenancyByDomain','PreventAccessFromCentralDomains','web','tenantenvironment']], function () {
    ...
    // Added By Mutaman For Syberpay
    Route::post('/syberpay/notify', '\App\Lib\Syberpay@notify');
    Route::get('/syberpay/payment-success', '\App\Lib\Syberpay@syberpaysuccess');
});
